<template>
    <div class="pages">
        ...
        <div class="page-container">
            <div
                v-if="overflow && (get.current_page > 3 || get.current_page === 2)"
                @click="fetch(1)"
                class="page selectable"
            >
                {{ 1 }}
            </div>
            <div v-if="enterPageOne" v-click-outside="enterPageClickOutside" class="page">
                <input
            ...
            <div
                ...
                v-if="overflow && get.current_page < get.last_page - 1 && !enterPageTwo"
                class="page"
            >
                ...
            </div>
            <div v-if="enterPageTwo" v-click-outside="enterPageClickOutside" class="page">
                <input
...
export default {
    ...
    methods: {
        ...
        paginate(e) {
            if (e.target.className.includes('left') && this.get.current_page > 1) {
